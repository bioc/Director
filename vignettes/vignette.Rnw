...
<<echo=TRUE,print=FALSE>>=
table1_v2 <- rbind(table1, 
    # add to the example two transcript->gene->transcript loops
...
sankey2 <- makeSankey(tempList2, averagePath=FALSE,
